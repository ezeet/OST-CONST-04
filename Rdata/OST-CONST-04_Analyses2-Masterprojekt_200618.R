...
stats::anova(fit_stab_1, fit_stab_2) # Fit2 better

# Haupteffekt self_other_condition auf Stability
summary(fit_stab_2)

lsr::cohensD(stability_value ~ self_other_condition, data = long_neg)
...
stats::anova (fit_stab_1, fit_stab_3)

# Haupteffekt ostracism_condition auf Stability
summary(fit_stab_3)

lsr::cohensD(stability_value ~ ostracism_condition, data = long_neg)
...
# effect size self_other_condition: 0.647
# effect size ostracism_condition: 0.22
# effect size interaktion: 0.692
...
stats::anova (fit_locus_1, fit_locus_2)

# Haupteffekt self_other_condition auf Locus
summary(fit_locus_2)

lsr::cohensD(locus_value ~ self_other_condition, data = long_neg)
...
lsr::cohensD(locus_value ~ ostracism_condition, data = long_neg)
...
# effect size self_other_condition: 0.269
# effect size ostracism_condition: 0.548
# effect size interaktion: 0.075
